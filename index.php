	        ...
	        <div class="container">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex  align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
		          		<span class="subheading">Assalam U Alykum!</span>
			            <h1 class="mb-4 mt-3">I'm <span>Misbah Ansari</span></h1>
	        ...
	        <div class="container">
	          <div class="row d-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
		          		<span class="subheading">Assalam U Alykum</span>
			            <h1 class="mb-4 mt-3">I'm a <span>web designer</span> based in Karachi</h1>
			            <p><a href="#" class="btn btn-primary py-3 px-4">Hire me</a> <a href="#" class="btn btn-white btn-outline-white py-3 px-4">My works</a></p>
		            </div>
		          </div>
	        	</div>
    		...
    		<div class="row d-flex">
    			...
    			<div class="col-md-6 col-lg-7 pl-lg-5 pb-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		            ...
		            <p>One Day You Will Thank To You For Never Giveup.</p>
		            <ul class="about-info mt-4 px-md-0 px-2">
		            	<li class="d-flex"><span>Name:</span> <span>Misbah Ansari</span></li>
		            	<li class="d-flex"><span>Date of birth:</span> <span>16-August</span></li>
		            	<li class="d-flex"><span>Address:</span> <span>Karachi</span></li>
		            	<li class="d-flex"><span>Zip code:</span> <span>1000</span></li>
		            	<li class="d-flex"><span>Email:</span> <span>misbahansari688@gmail.com</span></li>
		            	<li class="d-flex"><span>Phone: </span> <span>0335-2073761</span></li>
		            </ul>
		          </div>
		        </div>
